...
//
// COPY of app/lib/somfy-client.js, kept so the probes need no install step
// (same arrangement as probe/imou/imou-client.js). Edit the app's copy and
...
//
// Guest is enough for everything the driver does, including arming and
...
class SomfyClient {
  ...
  // Body field is `status`, not `security_level` — see app/lib/somfy-client.js.
